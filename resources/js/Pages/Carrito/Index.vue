...
import { route } from 'ziggy-js' // 👈 agregado para usar rutas con nombre
  ...
  <div class="max-w-5xl mx-auto p-6 space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center gap-2">
        ...
        <h1 class="text-3xl font-extrabold text-amber-600 drop-shadow-sm tracking-tight flex items-center gap-2">
          🧺 Carrito
        </h1>
      </div>
      ...
      <div class="flex gap-2">
        ...
        <button v-if="hayItems" @click="clearCart"
    ...
    <div v-else class="grid lg:grid-cols-3 gap-6">
      <div class="lg:col-span-2 space-y-3">
        <div v-for="it in props.items" :key="it.id"
