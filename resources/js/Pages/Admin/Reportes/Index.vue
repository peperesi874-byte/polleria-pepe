...
// Pequeños helpers para botones y enlaces
              ...
              <div class="flex-1">
                ...
                <div class="mt-4 flex flex-wrap items-center gap-2">
                  <a :href="route('admin.inventario.export.csv')" class="!mr-2" :class="btn('outline')">
                    <!-- csv icon -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="currentColor"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8zm1 7H9V7h6zm0 4H9v-2h6zm-3 4H9v-2h3z"/></svg>
                    CSV
                  </a>

                  <a :href="route('admin.inventario.export.pdf')" target="_blank" :class="btn('solid')">
                    <!-- pdf icon -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="currentColor"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8zm-1 13h-1v3h-2v-8h3a2 2 0 0 1 0 4zm0-3h-1v1h1a.5.5 0 0 0 0-1z"/></svg>
                    PDF
                  </a>
                </div>
              </div>
              ...
              <div class="flex-1">
                ...
                <div class="mt-4 flex flex-wrap items-center gap-2">
                  <a :href="route('admin.inventario.historial.csv')" :class="btn('outline')">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="currentColor"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8zm1 7H9V7h6z"/></svg>
                    CSV
                  </a>
                  <Link :href="route('admin.inventario.index')" class="text-sm text-indigo-600 hover:underline">
                    Ir a inventario →
              ...
              <div class="flex-1">
                ...
                <div class="mt-4">
                  <a :href="route('admin.reportes.productos.csv')" :class="btn('outline')">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="currentColor"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/></svg>
                    CSV
                  </a>
                </div>
              </div>
