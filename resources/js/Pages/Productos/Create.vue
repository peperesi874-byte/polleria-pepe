  ...
  <div class="max-w-6xl mx-auto px-6 py-8">
    ...
    >
      <div class="flex items-center gap-3">
        ...
        <div>
          <h1 class="text-2xl font-bold tracking-tight text-gray-900">Nuevo producto</h1>
    ...
    >
      ...
      <div class="lg:col-span-2 space-y-5">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
          <h2 class="mb-4 text-base font-semibold text-gray-800">Datos generales</h2>
        ...
        <!-- Card estado -->
        <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
          <h2 class="mb-4 text-base font-semibold text-gray-800">Estado</h2>
      ...
      <!-- Columna derecha (1/3): imagen / preview -->
      <div class="space-y-5">
        <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
          <h2 class="mb-4 text-base font-semibold text-gray-800">Imagen</h2>
      ...
      <!-- Barra de acciones sticky (full width al final del form) -->
